...
import { mediaSchema, type TMediaSchema } from '../../Models/media.model';
import { CustomDialog } from '../../Global/custom-dialog-box';
        ...
        <section className='space-y-2'>
          ...
          </section>
          {
            form.formState.errors.originalName && (
              <p className='text-red-500'>{form.formState.errors.originalName?.message}</p>
            )
          }
        </section>
